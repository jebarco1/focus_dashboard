...
export const verticalValidationWizardNavData = [
  ...
  export const customHorizontalWizardNavData = [
    { activeTab: 1, iconName: "fa-user", tittle: "Personal info" },
    { activeTab: 2, iconName: "fa-chain-broken", tittle: "Connect bank account" },
    { activeTab: 3, iconName: "fa-group", tittle: "Inquiries" },
  ...
  export const itemsName = ["Featured Items", "Newsletters", "Notifications", "Blogs"];
